...
var STRINGS_KO = {
  ...
  'home.shareHelp.summary': '공고를 빠르게 옮겨오는 법',
  'home.shareHelp.intro': '채용 앱마다 방식이 달라요. 급여·근무시간까지 자동으로 채우려면 ②번 붙여넣기를 쓰는 게 가장 확실합니다.',
  'home.shareHelp.step1': '① 공유가 되는 앱(알바천국 등): 공고 화면에서 공유 → 목록에서 "직비"를 선택하면 등록 화면이 열려요. 다만 대부분 제목과 링크까지만 들어옵니다.',
  'home.shareHelp.step2': '② 급여·근무시간까지 채우려면: 공고 내용을 복사한 뒤, 공고 추가 화면 맨 위 "공고 내용 붙여넣기" 칸에 붙여넣고 "이 내용으로 채우기"를 누르세요.',
  'home.shareHelp.step3': '사람인·알바몬처럼 공유 목록에 직비가 아예 안 뜨는 앱도 있어요. 그 앱들은 자체 공유창(카톡·문자 등)만 띄우기 때문이라, ②번 붙여넣기로 등록하면 됩니다.',
  'home.shareHelp.note': '공고 글이 복사가 안 되는 사이트라면, 공고 추가 화면의 "공고 복사가 안 될 때" 도움말을 보세요.',
